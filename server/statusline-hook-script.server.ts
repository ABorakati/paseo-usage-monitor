/**
 * The hook the Usage provider surface installs. Generated from
 * statusline-hook.mjs at the plugin root, which is the copy a reader can run
 * by hand; a test holds the two byte-identical so they cannot drift.
 */

export const STATUSLINE_HOOK_SCRIPT = String.raw`#!/usr/bin/env node
/**
